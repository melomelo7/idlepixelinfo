...
function buildColumns(arraySource,targetTable,itemDisplayTop,itemDisplayMiddle,imgSize){
    ...
    arraySource.forEach((item)=>{
        ...
        img.src = gameLook.includes("Old") ? item.img :
                ...
                if (item.type !== "ore"){
                    ...
                    for (i=0;i<item.ingredients.length;i++){
                        ...
                        thisDiv.style = containerRow
                            ...
                            img = new Image(30,30)
                            img.src = gameLook.includes("Old") ? "./IPM Components/"+item.ingredients[i].label+".jpg" :
    ...
    if (displayChosen === "list"){
        ...
        thisContainer.style.marginLeft = 20 + "px"
            ...
            thisContainer.appendChild(subContainer)
                ...
                img.src = gameLook.includes("Old") ? "./IPM Components/" + myArray[0][0].item.label + ".jpg" :
            ...
            for (i=0;i<filteredArray.length;i++){
                ...
                if (switchItem !== filteredArray[i].type){
                    ...
                    img = new Image (40,40)
                    img.src = gameLook.includes("Old") ? "./IPM Components/" + filteredArray[i].label + ".jpg" :
...
function craftDiv(thisCraft,table,row,cel){
    ...
    thisContainer.style.height = 360 + "px"
        ...
        thisContainer.appendChild(subContainer)
            ...
            let img = new Image (40,40)
            img.src = gameLook.includes("Old") ? "./IPM Components/" + thisCraft.item.label + ".jpg" :
        ...
        for (k=0;k<thisCraft.item.ingredients.length;k++){
            ...
            thisContainer.appendChild(subContainer)
                ...
                img = new Image (40,40)
                img.src = gameLook.includes("Old") ? "./IPM Components/" + thisCraft.item.ingredients[k].label + ".jpg" :
