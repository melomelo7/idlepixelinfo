...
let global = addEle({dad:body,setClass:"contCol",alignItems:"center"})
    addEle({dad:global,text:"Start Zelda Quiz",setClass:"btn",setFunc:startQuizz,
    ...
    setID:"scoring",radius:"20px",minWidth:"380px",minHeight:"80px",marginL:"5px",display:"none"})
        ...
        let rewC = addEle({dad:cont,setClass:"contRow",setID:"dispRewards"})
            ...
            addEle({dad:rewC,text:"Schoolhouse Quizz Rewards :",marginR:"10px"})
...
function answerQ(){
    ...
    if(Ans.value !== "-- Answer --" && player.progress <= questions.length){
        ...
        if(player.progress <= questions.length){
            ...
            Q.innerHTML = "You have completed the Quizz !!!<br>Starting again will now show your progress"
