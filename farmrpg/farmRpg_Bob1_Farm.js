...
(Day 15) 11/24  : Open after game reset, active until 4AM then relax, close 5AM
  ...
  subC2 = addEle({dad:cont,setClass:"contRow",})
    ...
    radius:"10px",display:"none",padding:"10px",width:"fit-content"})
        subC2 = addEle({dad:getID("lemonSplit"),setClass:"contRow"})
            addEle({dad:subC2,text:"AP Generated by the order :"})
            addEle({dad:subC2,what:"input",isInput:true,margin:"0 5px",setID:"apBank1",
            disabled:true,width:"30px"})
            addEle({dad:subC2,text:", Split "})
            addEle({dad:subC2,what:"input",isInput:true,margin:"0 5px",setID:"apBank2",
            disabled:true,width:"30px"})
            addEle({dad:subC2,what:"range",isInput:true,width:"50px"})
            addEle({dad:subC2,what:"input",isInput:true,margin:"0 5px",setID:"apBank3",
            disabled:true,width:"30px"})
    */
